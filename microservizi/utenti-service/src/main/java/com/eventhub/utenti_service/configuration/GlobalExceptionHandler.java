...
import com.eventhub.utenti_service.dto.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> handleBadCredentialsException(@NotNull BadCredentialsException ex,
                        @NotNull WebRequest request) {
                Map<String, String> errors = new HashMap<>();
                errors.put("error", ex.getMessage());
                // sendMail(ex, request);
